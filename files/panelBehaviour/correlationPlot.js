...
function CorrelationPlot () {
    ...
    function updateLines() {
        ...
        var min1 = d3.min([xExtend[0], yExtend[0]]);
        var max1 = d3.max([xExtend[1], yExtend[1]]);
        ...
        _gPlot.append("line")
            .attr('class', 'line')
            .attr('stroke', 'grey')
            .attr('x1', _xScale(min1))
            .attr('x2', _xScale(max1))
            .attr('y1', _yScale(correlatedTrend*min1+correlatedIntercept))
            .attr('y2', _yScale(correlatedTrend*max1+correlatedIntercept));
        ...
        // var equationLabel = (selectedDimension2.label ? selectedDimension2.label : selectedDimension2.key)
        //     + " = " + f(correlatedIntercept) + " + " + f(correlatedTrend) + "*"
        //     + (selectedDimension1.label ? selectedDimension1.label : selectedDimension1.key);
